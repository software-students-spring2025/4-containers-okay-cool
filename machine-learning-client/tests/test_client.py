...
def get_minimal_jpg():
    ...
    minimal_jpeg = base64.b64decode(
        ...
        "/////////////////////////////////////////////////////"
        "wAALCAABAAEBAREA/8QAJgABAAAAAAAAAAAAAAAAAAAAAxABAAAAAAAAAAAAAAAAAAAAAP/aAAgBAQAAPwBH/9k="
    )
...
class TestFaceRedactionClient(unittest.TestCase):
    ...
    def test_process_gridfs_images(self):
        ...
        processed_record = self.db.image_processing.find_one(
            {"input_file_id": input_file_id}
        )
